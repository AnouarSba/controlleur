    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @if(Illuminate\Support\Facades\Auth::user()->is_ == 2) <li
                ...
                <li class="nav-item">
                    <a class="nav-link {{ str_contains(request()->url(), 'ticket') == true ? 'active' : '' }}"
                        href="/ticket">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-notification-70 text-dark text-sm opacity-10"></i>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ str_contains(request()->url(), 'Control') == true ? 'active' : '' }}"
                        ...
                        <span class="nav-link-text ms-1">وضعية أيام الراحة التعويضية</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ str_contains(request()->url(), 'Control') == true ? 'active' : '' }}"
                        ...
                        <span class="nav-link-text ms-1">وضعية أيام الراحة الكاملة</span>
                    </a>
                </li>
                <!-- 
            <li class="nav-item">
