...
<body>
    ...
    <div class="page">
        ...
        <div style="height: 100vh" class="pcss3t pcss3t-effect-scale pcss3t-theme-1">
            @if (Illuminate\Support\Facades\Auth::user()->is_ == 1)
                <input type="radio" name="pcss3t" checked id="tab1"class="tab-content-first">
                <label for="tab1"><i class="icon-user"></i>Controleurs</label>
            @else
                <input type="radio" name="pcss3t" checked id="tab1"class="tab-content-first">
                        ...
                        <form action="{{ route('fill_pointage') }}" method="POST" id="form">
                            ...
                            <div class="row">
                                @foreach ($controleurs as $controleur)
                                    @php
                                        $state = $controleur->get_status($today);
                                    @endphp
                                    ...
                                    <div class="col-lg-6 col-sm-12  border border-primary p-2 mb-2">
                                        ...
                                        <div class="form-check"> <!-- Use form-check for checkbox styling -->
                                            ...
                                            <label class="form-check-label" for="ctrl{{ $controleur->id }}">
                                                {{ $controleur->username }}
                                            </label>
                            ...
                            <button type="submit" name="ctrl" class="btn btn-primary">Enregistrer</button>
                        </form>
                    @else
                        <form action="{{ route('fill_pointage') }}" method="POST" id="form">
                            @csrf
                            ...
                            <div class="row">
                                @foreach ($receveurs as $receveur)
                                    @php
                                        $state = $receveur->get_status($today);
                                    @endphp
                        ...
                        <form action="{{ route('fill_pointage') }}" method="POST" id="form">
                            ...
                            <div class="row">
                                @foreach ($chauffeurs as $chauffeur)
                                    @php
                                        $state = $chauffeur->get_status($today);
                                    @endphp
                                    <div class="col-lg-6 col-sm-12  border border-primary p-2 mb-2">
                                        <!-- Added col-4 for column layout and mb-3 for margin bottom -->
                                        <div class="form-check"> <!-- Use form-check for checkbox styling -->
                                            {{-- <input class="form-check-input" type="checkbox" name="ch[]" value="{{ $chauffeur->id }}" id="ch{{ $chauffeur->id }}"> --}}
