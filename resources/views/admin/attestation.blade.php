...
<body>
    @if(isset($attestation) && $attestation == 1)
<script>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('attestation_reg')}}" method="post">
                    @csrf
                    هل أنت متأكد بأنك قمت بمعالجة طلب شهادة العمل
