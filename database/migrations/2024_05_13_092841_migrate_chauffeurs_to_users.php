...
class MigrateChauffeursToUsers extends Migration
{
    public function up()
    {
...
$file = fopen('chauffeurs_passwords.txt', 'w');
        ...
        foreach ($chauffeurs as $key => $chauffeur) {
            ...
            DB::table('users')->insert([
                ...
                'email' => $this->generateUniqueEmail($chauffeur->fr_name.$key), // You may need a function to generate a unique email
